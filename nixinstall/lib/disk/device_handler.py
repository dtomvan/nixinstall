...
class DeviceHandler:
	...
	def get_btrfs_info(
		...
		if not lsblk_info.mountpoint:
			...
			# "mountpoint": "/mnt/nixinstall/var/log"
			# "mountpoints": ["/mnt/nixinstall/var/log", "/mnt/nixinstall/home", ..]
		...
		# "mountpoints": ["/mnt/nixinstall/log", "/mnt/nixinstall/home", "/mnt/nixinstall", ...]
		# "fsroots": ["/@log", "/@home", "/@"...]
