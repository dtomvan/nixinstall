...
from nixinstall.lib.general import SysCommandWorker
...
class AuthenticationHandler:
	...
	def _configure_u2f_mapping(
		...
		for user in users:
			Tui.print('')
			Tui.print(f'Setting up U2F device for user: {user.username}')
			Tui.print('You may need to enter the PIN and then touch your U2F device to register it')
